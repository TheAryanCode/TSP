...
def solve_tsp_dynamic(cities):
    ...
    def compute_subset(cities_set, j):
        return min([(cities_a[(cities_set - {j}, k)][0] + distance_matrix[k][j],
